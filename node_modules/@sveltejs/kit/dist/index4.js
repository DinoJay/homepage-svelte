...
function start({ port, config }) {
	return new Promise((fulfil) => {
		const app = index.requireRelative_1('./.svelte/build/optimized/server/app.cjs');
